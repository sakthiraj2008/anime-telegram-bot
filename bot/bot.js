...
// COMMAND: /stats (Displays MongoDB connection status, anime count, and total episodes uploaded)
bot.onText(/\/stats/, async (msg) => {
    ...
    try {
        ...
        // 3. Count Total Episodes across all Seasons
        const allAnime = await Anime.find({}, 'seasons');
        let totalEpisodes = 0;
...
━━━━━━━━━━━━━━━━━━━━━━`;
        ...
        bot.sendMessage(msg.chat.id, "❌ Error retrieving database statistics.");
    }
});
